    ...
    <div class="row g-4 mt-2">
      ...
      <div class="col-md-6">
        <div class="card h-100 shadow-sm border-0 rounded-4 overflow-hidden card-hover transition" style="transition: transform 0.2s, box-shadow 0.2s;">
          <div class="card-body p-4 d-flex flex-column text-center" style="background: linear-gradient(135deg, #ffffff 0%, #f8f9fa 100%); border-top: 5px solid #0d6efd;">
            ...
            <h5 class="card-title fw-bold text-dark mb-2">Preventive Maintenance</h5>
            <p class="card-text text-muted mb-4" style="font-size: 0.85rem;">Pengecekan rutin terencana (harian/mingguan) untuk mencegah kerusakan mesin.</p>
            <a href="<?= site_url("checklist/plant/{$plantSlug}/{$departemenSlug}/checklist-report?id_mesin=" . (int)$mesin['id_mesin']) ?>" class="btn btn-primary w-100 py-2 fw-bold rounded-3 mt-auto">Mulai Preventive &raquo;</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6">
        <div class="card h-100 shadow-sm border-0 rounded-4 overflow-hidden card-hover transition" style="transition: transform 0.2s, box-shadow 0.2s;">
          <div class="card-body p-4 d-flex flex-column text-center" style="background: linear-gradient(135deg, #ffffff 0%, #f8f9fa 100%); border-top: 5px solid #fd7e14;">
            <div class="d-inline-flex align-items-center justify-content-center bg-warning bg-opacity-10 text-warning p-3 rounded-circle mb-3 mx-auto" style="width: 70px; height: 70px;">
            ...
            <h5 class="card-title fw-bold text-dark mb-2">Overhaul Maintenance</h5>
            <p class="card-text text-muted mb-4" style="font-size: 0.85rem;">Pemeriksaan dan pembongkaran menyeluruh untuk perbaikan besar mesin secara berkala.</p>
            <a href="<?= $hasJenis ? site_url("checklist/plant/{$plantSlug}/{$departemenSlug}/overhaul?id_mesin=" . (int)$mesin['id_mesin']) : '#' ?>" <?= !$hasJenis ? 'onclick="return blockEmptyJenis()"' : '' ?> class="btn btn-warning text-white w-100 py-2 fw-bold rounded-3 mt-auto">Mulai Overhaul &raquo;</a>
          </div>
        </div>
      </div>
      <?php endif; ?>
