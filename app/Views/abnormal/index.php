...
<table class="kop-table text-center shadow-sm">
  <tr>
    <td colspan="6" class="kop-table-title" style="padding: 10px;">ABNORMAL REPORT CONDITION</td>
  </tr>
  <tr>
...
<div class="modal fade" id="editAbnormalModal" tabindex="-1" aria-labelledby="editAbnormalModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-md">
    <div class="modal-content border-0 shadow-lg rounded-4">
      ...
      <form action="<?= site_url('abnormal/update') ?>" method="post" id="abnormalUpdateForm" enctype="multipart/form-data" novalidate onsubmit="return validateAbnormalForm(event)">
        <?= csrf_field() ?>
...
<script>
  ...
  // Event delegation pada document (paling atas, tidak bisa di-intercept)
  ...
  }, true); // true = capture phase, tidak bisa diblokir
