        ...
        <thead>
          <tr style="background-color: #f7e600;">
            <th colspan="12" style="text-align: center; border: 1.5pt solid #000; padding: 10px;">
              ...
              <div style="font-size: 16px; font-style: italic; font-weight: bold;"><?= !empty($isOverhaul) ? 'OVERHAUL' : 'PREVENTIVE MAINTENANCE' ?></div>
            </th>
          </tr>
          <tr style="background-color: #f2f2f2;">
            <th colspan="7" style="text-align: left; border: 1.5pt solid #000; padding: 4px; font-style: italic; font-size: 11px;">
              JENIS <?= !empty($isOverhaul) ? 'OVERHAUL' : 'PREVENTIVE' ?> : <?= strtoupper($kategoriFilter) ?> <?= $bulanNama === 'SEMUA' ? 'SEMUA BULAN' : 'BULAN ' . $bulanNama ?>
            </th>
