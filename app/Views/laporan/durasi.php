  ...
  <?php else: ?>
    <div class="table-responsive text-nowrap">
      <form id="filterForm" action="<?= site_url('laporan/durasi') ?>" method="GET">
        <table class="table table-sm align-middle table-hover paginated-table" data-ajax-pagination="true" data-total-items="<?= esc($totalItems ?? 0) ?>" data-per-page="<?= esc($perPage ?? 15) ?>" data-current-page="<?= esc($_GET['page_durasi'] ?? 1) ?>">
          <thead>
            <tr>
