...
// Find public function downloadExcelDetail
$pos = strpos($c, 'public function downloadExcelDetail');
if ($pos === false) {
    die("Could not find downloadExcelDetail");
}

// Find public function exportExcelAll
$pos2 = strpos($c, 'public function exportExcelAll', $pos);
if ($pos2 === false) {
    die("Could not find exportExcelAll");
}

// Find the end of exportExcelAll
$pos3 = strpos($c, "\n    }", $pos2);
if ($pos3 === false) {
    die("Could not find end of exportExcelAll");
}

$endOfExportExcelAll = $pos3 + 6;

// Keep everything up to the end of exportExcelAll
$c = substr($c, 0, $endOfExportExcelAll);
...
echo "Clean replacement completed!";
