...
if (strpos($content, $oldExport) !== false) {
    $content = str_replace($oldExport, $newExport, $content);
    file_put_contents($file, $content);
    echo "MesinController export successfully updated.\n";
} else {
    echo "Failed to find the target string in MesinController.\n";
}
