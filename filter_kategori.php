...
// Add JS logic at the end of the script block
$jsToAppend = <<<'EOD'
...
// Find the end of the script block to append
$content = str_replace('});', '});' . "\n" . $jsToAppend, $content);

file_put_contents($file, $content);
echo "Frontend filtering applied to jadwal index.php\n";
